...
def Bspline3_2D_vector_fast(x, y, delta):  # faster than Bspline3_2D_vector
...
Fit_Spline_To_Normal = False
if Fit_Spline_To_Normal:
   ...
   popt, _ = curve_fit(spline_model, x_fit, y_target, p0=initial_guess)
